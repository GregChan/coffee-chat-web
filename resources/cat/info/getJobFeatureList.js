...
exports.path='cat/info/getJobFeatureList';

exports.getHandle=function (req,res) {
	getJobFeatureList(res);
}

function getJobFeatureList(res)
{
	var p1 = dbConn.getJobFeatureList();
	return p1.then(
        function(val)
        {
           console.log("getJobFeatureList: then: "+ val);
